    ...
    class Meta:
        ...
        constraints = [
            models.CheckConstraint(
                ...
                check=models.Q(percentage_read__gte=0, percentage_read__lte=100),
            ),
            models.CheckConstraint(
            ...
            models.CheckConstraint(
                ...
                check=(
                    models.Q(percentage_read__exact=0, start_read_date__isnull=True)
                    | models.Q(percentage_read__gt=0, start_read_date__isnull=False)
                ),
            ),
            models.CheckConstraint(
                name="%(app_label)s_%(class)s_per_read_end_read_date_check",
                check=(
                    models.Q(percentage_read__exact=100, end_read_date__isnull=False)
                    | models.Q(percentage_read__lt=100, end_read_date__isnull=True)
                ),
            ),
        ]
